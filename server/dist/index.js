...
const lrangeAsync = util_1.promisify(client.lrange).bind(client);
const hmsetAsync = util_1.promisify(client.hmset).bind(client);
const rpushAsync = util_1.promisify(client.rpush).bind(client);
...
flushallAsync();
const objToArr = obj => Object.keys(obj).reduce((acc, key) => [...acc, key, obj[key]], []);
